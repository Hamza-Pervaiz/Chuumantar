...
class ListOfCompanyNames extends StatefulWidget {
  ...
  @override
  State<ListOfCompanyNames> createState() => _ListOfCompanyNamesState();
}

class _ListOfCompanyNamesState extends State<ListOfCompanyNames> {
  ...
  void initState() {
    ...
    CommonFuncs.showToast(
        "listofcompanynamesformaincategory\nListOfCompanyNames");
      ...
      body: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              widget.selectedSubcategory == 'main'
                  ? "My Categories / ${widget.parentCatName}".tr()
                  : widget.selectedSubcategory == 'sub'
                      ? "My Categories / ${widget.parentCatName} / ${widget.selectedSubcategory}"
                          .tr()
                      : "My Categories / ${widget.parentCatName} / ${widget.selectedSubCat} / ${widget.selectedSubcategory}"
                          .tr(),
                      ...
                      child: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return GestureDetector(
                            onTap: () async {
                              print(
                                  "jjjjjjjcompimage: ${AppUrls.imageUrl}${widget.matchinSurvey[index]["companylogoimage"]}");
                              await showDialog(
                                          ...
                                          ElevatedButton(
                                            onPressed: () async {
                                              if (widget.commingfFrom ==
                                                ...
                                                //   context,
                                                //   PageRouteBuilder(
                                                //     pageBuilder: (context, animation1, animation2) => SmokeViewForSurveys(),
                            ...
                            child: Container(
                              ...
                              child: ListTile(
                                  ...
                                  subtitle: RichTextHelperCategory(
