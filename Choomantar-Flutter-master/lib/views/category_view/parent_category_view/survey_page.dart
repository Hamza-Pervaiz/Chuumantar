...
String? nextQuestion ='Next Question'.tr();
String? points;
String booltoString='';
  ...
  void initState() {
    ...
    if(mounted) {
      ...
      Future.delayed(const Duration(seconds: 4), () {
        if (kDebugMode) {
          print("jjjtimer: inside future delayed initstate");
        }
   ...
   // widget.isTimer ? startTimer() : null;
    ...
    CommonFuncs.showToast("survey_page\nSurveyPage");
  ...
  Future<void> submitSurveyQuestions(String questionId, List<String> answer, bool isLastQuestion) async {
    ...
    try {
      log('user id is: ${[preff!.get('uid').toString()]} ,question id is: $questionId ,and answer is${[answer.join(',')]}');
      var response = await http.post(Uri.parse(AppUrls.submitSurvey), body: {
      ...
      if (response.statusCode == 200) {
        ...
        CommonFuncs.apiHitPrinter("200", AppUrls.submitSurvey,
            "POST", "userId: ${preff!.get('uid').toString()}\n"
                "questionId: $questionId\n"
                "answer: ${answer.join(',')}\n"
                "lastanswer: $booltoString",
            dataa, "survey_page");
        ...
        CommonFuncs.apiHitPrinter(response.statusCode.toString(), AppUrls.submitSurvey,
            "POST", "userId: ${preff!.get('uid').toString()}\n"
                "questionId: $questionId\n"
                "answer: ${answer.join(',')}\n"
                "lastanswer: $booltoString",
  ...
  List<String>? localSelectedOptions;
                        ...
                        child: FadeInAnimation(
                          child: GestureDetector(
                            onTap: () {
                              ...
                              if (kDebugMode) {
                                print("jjselecteddata: ${questionData['selected_options']}");
                              }
                            },
                            child: Container(
            ...
            onPressed: () async {
              ...
              } else
              {
                    ...
                    showDialog(
                        ...
                        builder: (BuildContext context) {
                          return validationDialog(context,
                              ...
                              oprText: "You are not paying attention.You will have to retake survey again.".tr(),
                              ontap: () {
                                Navigator.pop(context);
                                Navigator.pop(context);
                                // questionPageController.previousPage(
                ...
                if (!isLastQuestion) {
                  ...
                  if (kDebugMode) {
                    print("jjsurvpage: inside if !islastQuestion");
                  }
                  ...
                  if (kDebugMode) {
                    print("jjsurvpage: inside else !islastQuestion");
                  }
...
//    bool isLastSurvey = widget.allSurveyData.length == 1;
