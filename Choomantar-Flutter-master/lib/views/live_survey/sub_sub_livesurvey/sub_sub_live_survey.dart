...
class SubSubCategoryViewLiveSurvey extends StatefulWidget {
 ...
 // final Future<List<dynamic>> showInteractiveSurvey;
  ...
  SubSubCategoryViewLiveSurvey({super.key, required this.subSubCategoryData,required this.onNextPagePressed,
  ...
  @override
  State<SubSubCategoryViewLiveSurvey> createState() => _SubSubCategoryViewLiveSurveyState();
}

class _SubSubCategoryViewLiveSurveyState extends State<SubSubCategoryViewLiveSurvey> {
  ...
  void initState() {
    ...
    super.initState();
    CommonFuncs.showToast("sub_sub_live_survey\nSubSubCategoryViewLiveSurvey");
    print("jjjjjjjj3333:"+ widget.subSubCategoryData.toString());
  }
...
numberCompanies = widget.companyNames.length;
    return  Column(
      ...
      children: [
        ...
        Text('Live Polls / ${widget.selectedCategory} / ${widget.selectedSubcategory}',style: const TextStyle(color: AppColors.secondaryColor,fontSize: 22,fontWeight: FontWeight.w600),),
        // TextWidget(
