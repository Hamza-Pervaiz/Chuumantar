...
class CategoryCompLiveSurvey extends StatefulWidget {
  ...
  @override
  State<CategoryCompLiveSurvey> createState() => _CategoryCompLiveSurveyState();
}

class _CategoryCompLiveSurveyState extends State<CategoryCompLiveSurvey> {
  ...
  void initState() {
    ...
    super.initState();
    CommonFuncs.showToast("category_comp_live_survey\nCategoryCompLiveSurvey");
  }
  ...
  int countSurveysByParentCategory(
      List<dynamic> surveys, String parentCategory) {
    int count = 0;
