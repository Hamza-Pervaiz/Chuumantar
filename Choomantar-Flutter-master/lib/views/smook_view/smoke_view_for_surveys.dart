...
class SmokeViewForSurveys extends StatefulWidget {


  const SmokeViewForSurveys( {super.key});

  @override
  State<SmokeViewForSurveys> createState() => _SmokeViewForSurveysState();
}

class _SmokeViewForSurveysState extends State<SmokeViewForSurveys> {
