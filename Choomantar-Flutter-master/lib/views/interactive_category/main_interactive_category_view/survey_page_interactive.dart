...
final bool isTimer;
  ...
  @override
  State<SurveyPageInteractive> createState() => _SurveyPageInteractiveState();
}

class _SurveyPageInteractiveState extends State<SurveyPageInteractive>  {
...
String? booltoString='';
  ...
  void initState() {
    ...
    CommonFuncs.showToast("survey_page_interactive\nSurveyPageInteractive");
  }
